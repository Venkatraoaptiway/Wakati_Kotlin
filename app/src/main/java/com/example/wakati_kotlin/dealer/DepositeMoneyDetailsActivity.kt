...
import com.example.wakati_kotlin.databinding.ActivityDepositeMoneyDetailsBinding
...
class DepositeMoneyDetailsActivity : AppCompatActivity() {
    var binding: ActivityDepositeMoneyDetailsBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDepositeMoneyDetailsBinding.inflate(
            layoutInflater
        )
        ...
        binding!!.proceed.setOnClickListener { v: View? ->
            val intent = Intent(
                this@DepositeMoneyDetailsActivity, DepositeMoneyAccountActivity::class.java
            )
        ...
        client.newCall(request).enqueue(object : okhttp3.Callback {
            ...
            override fun onFailure(call: okhttp3.Call, e: IOException) {
                ...
                runOnUiThread {
                    ...
                    Toast.makeText(this@DepositeMoneyDetailsActivity, e.message, Toast.LENGTH_SHORT)
                        .show()
                }
            }
