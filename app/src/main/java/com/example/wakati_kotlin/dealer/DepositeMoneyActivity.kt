...
import com.example.wakati_kotlin.databinding.ActivityDepositeMoneyBinding
import com.google.gson.Gson
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class DepositeMoneyActivity : AppCompatActivity() {
    var binding: ActivityDepositeMoneyBinding? = null
    var sharedPreferences: SharedPreferences? = null
    var from: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDepositeMoneyBinding.inflate(
            layoutInflater
        )
    ...
    fun serviceProfile(authToken: String?, mobileNumber: String?) {
        ...
        retrofitClass.profileBymobile(object : Callback<LoginResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    if (profile != null) {
                        ...
                        // VALIDATION
                        if ("CUSTOMER" == userType || "INSTITUTIONAL_USER" == userType || "DEALER" == userType) {
                            var idNumber = ""
                            var documentId = ""
                            ...
                            val intent = Intent(
                                this@DepositeMoneyActivity,
                                DepositeMoneyDetailsActivity::class.java
                            )
                    ...
                    Toast.makeText(this@DepositeMoneyActivity, "USER NOT FOUND", Toast.LENGTH_SHORT)
                        .show()
                }
            }
            ...
            override fun onFailure(call: Call<LoginResponse?>, t: Throwable) {
                LoaderUtils.hideLoader()
                Toast.makeText(this@DepositeMoneyActivity, t.message, Toast.LENGTH_SHORT).show()
